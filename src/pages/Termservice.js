        ...
        <div className="max-w-7xl">
          <h1 className="pt-20 text-3xl font-extrabold leading-[70px] leading-tight sm:text-4xl md:text-5xl">
            ...
            <span className="block bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text leadingHeight leading-[70px] text-transparent">
              International Diamond Verified Lab Terms of Service
            </span>
          </h1>

          <div className="mx-auto mt-6 max-w-5xl text-base text-white/90 sm:text-lg">
            <p>
              Welcome to International Diamond Verified Lab Pvt Ltd. These Terms & Conditions outline the
          ...
          <div className="prose prose-sm prose-slate max-w-none text-slate-900">
            ...
            <ol className="ml-6 list-decimal space-y-4">
              ...
              <li>
                ...
                charges related to International Diamond Verified Lab Platform Services shall not be issued
              ...
              <li>
                ...
                (photo/video) before International Diamond Verified Lab or the Restaurant Partner can
              ...
              <li>
                ...
                payment method, unless refunded through International Diamond Verified Lab credits. The
            ...
            <p className="mb-2">
              ...
              cancellation due to reasons not attributable to International Diamond Verified Lab—such as
              ...
              authorization granted by you to International Diamond Verified Lab to place orders with
            ...
            <p className="mb-2">
              ...
              other involved parties (except International Diamond Verified Lab). You hereby authorize
              International Diamond Verified Lab to recover such liquidated damages through methods
              determined at International Diamond Verified Lab’s discretion, including but not limited to
              deduction from payments made toward your next order.
            </p>

            <p className="mb-2">
              However, there may be situations where International Diamond Verified Lab is unable to accept
              ...
              or other reasons attributable to International Diamond Verified Lab, the Restaurant Partner,
